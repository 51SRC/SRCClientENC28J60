...
U8 xdata FU_MAC[6]={0x01,0x12,0X34,0X56,0X78,0X92};//本地MAC
...
#else
	U8 xdata FU_LoaclIP[4]={192,168,0,101};//本地IP地址102/101
	U8 xdata FU_SubnetMask[4]={255,255,255,0};//子网掩码
...
void net_init(void)
{
	...
	Set_Re_HOST(2,TCP_CLIENT,"47.104.19.111",4001);//47.104.19.111 192.168.0.2
