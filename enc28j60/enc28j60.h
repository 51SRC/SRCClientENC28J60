...
//	nie 2008  -----
#define MAX_TX_BUFFER	0x600				  	//发送缓存为
#define MAX_RX_BUFFER	0x600					//接收缓存为8192-MAX_TX_BUFFER-1
// start with recbuf at 0/
#define RXSTART_INIT	0x0000	  				//接收缓存区开始地址
#define RXSTOP_INIT		(8192-MAX_RX_BUFFER-1)	//接收缓存结束地址
#define TXSTART_INIT	(8192-MAX_TX_BUFFER)	//发送缓存开始地址
#define TXSTOP_INIT		8192					//enc28j60一共8K收发缓存,
